...
class MandelboxFractal : public IFractalType {
 private:
    double scale;           // Scale factor for the Mandelbox
    double minRadius2;      // Minimum radius squared for folding
    double foldingLimit;    // Folding limit parameter
    
 public:
    MandelboxFractal(double scale = 2.0, double minRadius2 = 0.25, double foldingLimit = 1.0)
